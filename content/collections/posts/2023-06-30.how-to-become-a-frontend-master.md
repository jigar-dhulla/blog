---
id: 016eaae8-1ef2-406a-91a1-1f16770bd2a8
published: false
blueprint: post
title: 'How to become a Frontend Master'
featured_image: post_3.png
categories:
  - tutorials
updated_by: 5019d32a-932e-4e80-9d30-b60b20e24e87
updated_at: 1691341756
...
content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Whether you are new to programming or already an experienced developer. In this industry, learning new concepts and languages/frameworks is mandatory to keep up with the rapid changes. Take for example React - open-sourced by Facebook just a shy 4 years ago it already became the number one choice for JavaScript devs around the globe. But also Vue and Angular, of course, have their legitimate follower-base. And then there is Svelte, and universal frameworks like Next.js or Nuxt.js, and Gatsby, and Gridsome, and Quasar, and and and. If you want to shine as an expert JavaScript developer you should at least have some experience in different frameworks and libraries - besides doing your homework with good, old JS.'
  -
    type: paragraph
    attrs:
      textAlign: left
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Dictum integer fusce ac ridiculus'
  -
    type: paragraph
    attrs:
      textAlign: left
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Sodales hendrerit malesuada et vestibulum'
  -
    type: bulletList
    content:
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Luctus euismod pretium nisi et, est dui enim.'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Curae eget inceptos malesuada, fermentum class.'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Porttitor vestibulum aliquam porta feugiat velit, potenti eu placerat.'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Ligula lacus tempus ac porta, vel litora.'
  -
    type: paragraph
    attrs:
      textAlign: left
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Elementum nisi urna cursus nisl quam ante tristique blandit ultricies eget'
  -
    type: paragraph
    attrs:
      textAlign: left
